...
class Weather:
    def show(self,scrollable_text):
        SR=SpeakRecog(scrollable_text)
        base_url = "http://api.openweathermap.org/data/2.5/weather?q=Vellore,IN&units=metric&appid=ea45752424c9cad83b4f5c836ced6b1a"
        data=requests.get(base_url).json()
        SR.scrollable_text_clearing()
        SR.speak("-----------------------------Weather Report of Vellore City------------------------------")
